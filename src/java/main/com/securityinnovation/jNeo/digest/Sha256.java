...
public class Sha256 extends Digest {
  ...
  /* Get the length of the hash output, in bytes. For SHA-256, this will always return 32. */
  ...
  /*
   * Get the size of the input block for the core hash algorithm, in bytes. For SHA-256, this will
   * always return 64.
   */
