...
public class ManifestBBTestCase {
  ...
  @Test
  public void test_implementation_vendor() throws java.io.IOException {
    assertEquals("Security Innovation", getAttribute("Implementation-Vendor"));
  }

  @Test
  public void test_implementation_title() throws java.io.IOException {
    assertEquals("jNeo", getAttribute("Implementation-Title"));
  }

  @Test
  public void test_implementation_version() throws java.io.IOException {
    assertEquals("1.0rc2", getAttribute("Implementation-Version"));
  }
}
