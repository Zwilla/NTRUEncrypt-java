...
/*
 * This class provides a list of constant identifiers for the NtruEncrypt parameter sets. These
 * constants are for use during key generation, when the application must specify which parameter
 * set to use to create the new keypair.
 *
 * <p>The parameter sets named here are defined in the ANSI X9.98 specification.
 */
public enum OID {
  /*
