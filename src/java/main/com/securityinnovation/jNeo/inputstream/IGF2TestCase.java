...
public class IGF2TestCase {
  ...
  private boolean checkIGF(int bitsPerElement, byte[] inputStream, short[] expectedOutputStream) {
    ...
    for (int i = 0; i < out.length; i++) out[i] = (short) igf.nextIndex();
  ...
  public void test_8bit() {
    ...
    short[] expected = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88};
