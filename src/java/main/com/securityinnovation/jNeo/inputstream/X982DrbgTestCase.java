...
public class X982DrbgTestCase {
  ...
  private static final byte[] sha1_seed = {
  ...
  private static final byte[] sha1_reseed = {
  ...
  private static final byte[] sha1_ans = {
  ...
  private static final byte[] sha1_ans2 = {
  ...
  private static final byte[] sha1_ansr = {
  ...
  public void test_sha1_19() {
    X982Drbg drbg = new X982Drbg(DigestAlgorithm.sha1, sha1_seed);
    int n = 19;
    byte[] out = new byte[n];
  ...
  public void test_sha256_80_80_reseed_80() {
    X982Drbg drbg = new X982Drbg(DigestAlgorithm.sha256, sha256_seed);
    int n = 80;
    byte[] out = new byte[n];
    assertEquals(n, drbg.read(out, 0, n));
