...
/*
 * This class provides an abstraction of a polynomial. Instances contain an array of shorts that
 * hold the polynomial coefficients and the class provides operations to add, subtract, and multiply
...
public class FullPolynomial {
  ...
  /*
   * Initialize a polynomial with the given coefficient list. The degree of the polynomial will be
   * defined by the size of coeffs.
   *
  ...
  /*
   * Recenter the coefficients of a polynomial into the range [newLowerLimit..newLowerLimit+q), such
   * that the new coefficients equal the old coefficients mod q.
   *
  ...
  /*
   * Given two polynomials of the same degree N, compute a*b in the ring of polynomials of degree N.
   *
  ...
  /*
   * Given two polynomials of the same degree N, compute a*b in the ring of polynomials of degree N
   * whose coefficients are in the ring of integers mod coefficientModulus.
   *
   * @param a the first polynomial.
   * @param b the second polynomial. It must be of the same degree as a.
   * @param coefficientModulus the modulus for the coefficients of the resulting polynomial.
   * @return a*b modulo X^N.
   */
  public static FullPolynomial convolution(
      FullPolynomial a, FullPolynomial b, int coefficientModulus) {
  ...
  /*
   * Add two polynomials modulo coefficientModulus. The coefficients of the resulting polynomial
   * will be in the range [0..coefficientModulus-1].
   *
  ...
  /*
   * Add two polynomials modulo coefficientModulus. The coefficients of the resulting polynomial
   * will be in the range [newLowerLimit..newLowerLimit+coefficientModulus-1].
   *
   * @param a the first addend.
   * @param b the second addend.
   * @param coefficientModulus the modulus for the polynomial coefficients.
  ...
  public static FullPolynomial addAndRecenter(
      FullPolynomial a, FullPolynomial b, int coefficientModulus, int newLowerLimit) {
    FullPolynomial c = new FullPolynomial(a.p.length);
    for (int i = 0; i < c.p.length; i++) c.p[i] = (short) (a.p[i] + b.p[i]);
  ...
  /*
   * Subtract two polynomials modulo coefficientModulus. The coefficients of the resulting
   * polynomial will be in the range [0..coefficientModulus-1].
   *
   * @param a the minuend.
   ...
   * @return true iff o is a FullPolynomial with the same degree as this object and the respective
   *     coefficient lists contain the same values.
   */
