...
public class BitPackTestCase {
  ...
  public void test_pack5() {
    ...
    byte[] exptgt = {(byte) 0x80, (byte) 0x63, (byte) 0xf0, (byte) 0x4b, (byte) 0x5c, (byte) 0x08};
    byte[] tgt = new byte[exptgt.length];

    assertEquals(tgt.length, BitPack.pack(src.length, 0x20, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack8() {
    ...
    assertEquals(tgt.length, BitPack.pack(src.length, 0x100, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack9() {
    short[] src = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88};
    byte[] exptgt = {
      (byte) 0x40, (byte) 0x20, (byte) 0x50, (byte) 0x48,
      (byte) 0x34, (byte) 0x22, (byte) 0x15, (byte) 0x0c,
      (byte) 0x87, (byte) 0x44, (byte) 0x00
    };
    byte[] tgt = new byte[exptgt.length];

    assertEquals(tgt.length, BitPack.pack(src.length, 0x200, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack10() {
    short[] src = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88};
    byte[] exptgt = {
      (byte) 0x20, (byte) 0x08, (byte) 0x12, (byte) 0x08,
      (byte) 0x83, (byte) 0x21, (byte) 0x08, (byte) 0x52,
      (byte) 0x18, (byte) 0x87, (byte) 0x22, (byte) 0x00
    };
    byte[] tgt = new byte[exptgt.length];

    assertEquals(tgt.length, BitPack.pack(src.length, 0x400, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack11() {
    short[] src = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88};
    byte[] exptgt = {
      (byte) 0x10, (byte) 0x02, (byte) 0x04, (byte) 0x41,
    ...
    assertEquals(tgt.length, BitPack.pack(src.length, 0x800, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack12() {
    short[] src = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88};
    byte[] exptgt = {
      (byte) 0x08, (byte) 0x00, (byte) 0x81, (byte) 0x08,
    ...
    assertEquals(tgt.length, BitPack.pack(src.length, 0x1000, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_unpack5() {
    byte[] src = {(byte) 0x80, (byte) 0x63, (byte) 0xf0, (byte) 0x4b, (byte) 0x5c, (byte) 0x08};
    short[] exptgt = {0x10, 0x01, 0x11, 0x1f, 0x00, 0x12, 0x1a, 0x1c, 0x01};
    short[] tgt = new short[exptgt.length];

    assertEquals(src.length, BitPack.unpack(tgt.length, 0x20, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_unpack8() {
    ...
    assertEquals(src.length, BitPack.unpack(tgt.length, 0x100, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_unpack9() {
    ...
    assertEquals(src.length, BitPack.unpack(tgt.length, 0x200, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_unpack10() {
    ...
    assertEquals(src.length, BitPack.unpack(tgt.length, 0x400, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_unpack11() {
    ...
    assertEquals(src.length, BitPack.unpack(tgt.length, 0x800, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_unpack12() {
    ...
    assertEquals(src.length, BitPack.unpack(tgt.length, 0x1000, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack9_limited() {
    ...
    assertEquals(tgt.length, BitPack.pack(src.length, 0x200, 3, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack12_limited() {
    short[] src = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88};
    byte[] exptgt = {(byte) 0x08, (byte) 0x00, (byte) 0x81, (byte) 0x08, (byte) 0x20, (byte) 0x83};
    byte[] tgt = new byte[exptgt.length];

    assertEquals(tgt.length, BitPack.pack(src.length, 0x1000, 6, src, 0, tgt, 0));
    assertArrayEquals(exptgt, tgt);
  }
  ...
  public void test_pack12_long() {
    ...
    assertEquals(exptgt.length, BitPack.pack(src.length, 0x1000, tgt.length, src, 0, tgt, 0));
    // Verify the output
    assertArrayEquals(exptgt, subArray(tgt, 0, exptgt.length - 1));
  }
}
