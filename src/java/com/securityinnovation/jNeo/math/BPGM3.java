...
/*
 * This class implements the BPGM3 algorithm defined in the X9.98 standard, with a few
 * modifications.
 *
 * <p>The main routine of this class requires that the IGF be initialized before entry. This is to
 * allow testing with known inputs.
 *
 * <p>Also this implementation allows the number of "+1" coefficients to be different from the
 * number of "-1" coefficients. This was done to support some experiments with the BPGM3.
 */
public class BPGM3 {
  /*
   * Generate a trinomial of degree N-1 that has <code>numOnes</code> coeffcients set to +1 and
   * <code>numNegOnes</code> coefficients set to -1, and all other coefficients set to 0.
   */
