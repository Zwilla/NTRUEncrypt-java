...
/*
 * Defines an interface for finding the inverse of a polynomial. Different implementations of this
 * interface will be optimized for different moduli, this is why the modulus is not part of this
 * interface.
 */
