...
/*
 * This class holds the result of parsing a key blob. The result contains the parameter set, the
 * public key, and the private key (which will be null if the input blob was a public key blob).
 */
