...
public class KeyFormatterUtil {
  ...
  public static byte[] packListedCoefficients(FullPolynomial F, int numOnes, int numNegOnes) {
  ...
  public static int packListedCoefficients(
      FullPolynomial F, int numOnes, int numNegOnes, byte[] out, int offset) {
  ...
  public static int unpackListedCoefficients(
      FullPolynomial F, int N, int numOnes, int numNegOnes, byte[] in, int offset) {
    short[] coefficients = new short[numOnes + numNegOnes];
