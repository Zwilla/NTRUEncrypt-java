...
/*
 * This class provides an enumeration of hash algorithms that can be used throughout the code. Each
 * enumeration has a utility function for creating a new instance of a Digest object for that
 * algorithm.
 */
public enum DigestAlgorithm {
  ...
  public Digest newInstance() {
    try {
      return (Digest) clazz.getDeclaredConstructor().newInstance();
    }
